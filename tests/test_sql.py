...
def _trips(spark):
    rows = [
        ...
        (datetime(2024, 1, 1, 8, 0), datetime(2024, 1, 1, 8, 15), 2.5, 12.0, 1),
        # good 10-min trip at 08:00
        (datetime(2024, 1, 1, 8, 30), datetime(2024, 1, 1, 8, 40), 1.5, 9.0, 1),
        # bad: zero distance -> dropped
        (datetime(2024, 1, 1, 9, 0), datetime(2024, 1, 1, 9, 10), 0.0, 8.0, 1),
        # bad: negative fare -> dropped
        (datetime(2024, 1, 1, 9, 0), datetime(2024, 1, 1, 9, 10), 2.0, -3.0, 1),
    ]
